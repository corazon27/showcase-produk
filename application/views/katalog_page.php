...
<div class="container my-5">
                    ...
                    <div class="input-group shadow-sm border rounded flex-nowrap flex-grow-1 flex-md-grow-0">
                        ...
                        <select class="form-select border-0 ps-0 select-custom"
                            ...
                            <?php foreach($semua_kategori as $kat): 
                                // Buat slug yang sama persis dengan logika di Controller
                                $clean_name = str_replace(['(', ')', '&'], ['', '', ''], $kat['nama_kategori']);
                                $slug = url_title($clean_name, 'dash', TRUE);
                            ?>
                            <option value="<?= $slug; ?>"
                                <?= ($this->input->get('kategori') == $slug) ? 'selected' : ''; ?>>
                                <?= $kat['nama_kategori']; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
    ...
    <div class="row g-3 g-md-4" id="product-container">
        ...
        <div class="col-12 text-center py-5">
            ...
            <p class="text-muted mb-4 mx-auto" style="max-width: 500px;">
                ...
                Silakan coba cari dengan kategori lain atau hubungi admin kami.
            </p>
    ...
    <?php if (empty($produk) && !empty($rekomendasi)) : ?>
    <div class="row mt-5 pt-4 border-top">
        ...
        <div class="col-6 col-md-3 mb-5 px-2">
            <div class="product-card">
                <img src="<?= base_url('assets/img/produk/' . $r['foto_barang']); ?>" class="product-img"
                    alt="<?= $r['nama_barang']; ?>">
                <div class="card-body p-3">
                    <h6 class="fw-bold mb-3"><?= $r['nama_barang']; ?></h6>
